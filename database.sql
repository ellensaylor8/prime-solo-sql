...
UPDATE "accounts" SET "account_balance" = 10 WHERE "account_balance" = 0.00 AND "transactions_attempted" = 0;
...
VALUES ('billy', 'miami', '4', '5', '1000000');
...
DELETE FROM "accounts" WHERE "city" = 'phoenix' AND "transactions_completed" < 5 OR "city" = 'miami' AND "transactions_completed" < 5
